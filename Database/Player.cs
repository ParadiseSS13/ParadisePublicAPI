...
public partial class Player
{
    ...
    public int? Toggles3 { get; set; }

    public int? Sound { get; set; }

    public int Light { get; set; }

    public bool? Glowlevel { get; set; }
    ...
    public bool? ScreentipMode { get; set; }

    public string ScreentipColor { get; set; } = null!;

    public byte GhostDarknessLevel { get; set; }

    public string ColourblindMode { get; set; } = null!;

    public string? Keybindings { get; set; }

    public string? ServerRegion { get; set; }

    public string? MutedAdminsoundsCkeys { get; set; }

    public string Viewrange { get; set; } = null!;

    public string? MapVotePrefJson { get; set; }
}
